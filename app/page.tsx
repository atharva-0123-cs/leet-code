...
// import imge from '@/public/download.png';
import AuthModal from "./components/Modals/AuthModals";
import TopBar from "./components/TopBar/TopBar";
import ProblemsTable from "./components/ExamplesTables/ExampleTable";
...
export default function Home() {
  ...
  return (
    <main className="bg-dark-layer-2  ">
      <TopBar pathname={""}/>
      <h1
        className="text-2xl text-center text-gray-300 dark:text-gray-400 font-medium
